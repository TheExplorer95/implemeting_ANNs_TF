...
# Model
cpc = CPC(data_generator_arguments["T"], data_generator_arguments["k"],
          data_generator_arguments["N"], z_dim, c_dim, enc_model, ar_model,
          Predict_z, encoder_args, ar_args, mixed_precision)
...
# Training
train_cpc(cpc, train_ds_cpc, loss, adam, epochs_cpc, steps_per_epoch_cpc,
          mixed_precision, path_save_cpc)
